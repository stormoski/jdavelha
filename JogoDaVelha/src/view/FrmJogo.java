...
public class FrmJogo extends JFrame {
            ...
            if(c.getName() != null && c.getName().startsWith("lacuna")){
                ...
                label.addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseReleased(MouseEvent evt){
                        jogo.jogar(lacunas.indexOf(label));
                    }
                });
            }
        }

        jogo.addOuvinteStatus(new OuvinteStatus() {
            @Override
            ...
            public void acabouJogo(Status statusJogo) {
                JOptionPane.showMessageDialog(null, "O jogador " + statusJogo.getJogadorCorrente() + " ganhou!");
                iniciarJogo();
            }

            public void posicaoOcupada(Status statusJogo) {
                JOptionPane.showMessageDialog(null, "A posicao está ocupada. Jogue novamente.");
            }
        });
    ...
    public void iniciarJogo() {
        ...
        do{
            jogador1 = JOptionPane.showInputDialog("Digite o símbolo do 1º jogador, X ou O:").toUpperCase();

            if (jogador1.equals("X")) {
                jogador2 = "O";
            } else if (jogador1.equals("O")) {
                jogador2 = "X";
            }
        } while(!jogador1.equals("X") && !jogador1.equals("O"));
    ...
    private void initComponents() {
        ...
        lacuna1.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
