...
public class FrmJogo extends JFrame {
    ...
    public void iniciarJogo() {
        ...
        do{
            jogador1 = JOptionPane.showInputDialog(this, "Digite o símbolo do 1º jogador, X ou O:", "Escolher Símbolo",
